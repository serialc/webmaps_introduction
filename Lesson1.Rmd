...
date: "<br>Last update April 24, 2023"
output:
...
- Your total percentage contributes to **part** of your overall grade for this course.
]
...
- What are your conclusions regarding how data is structured?
...
- What components (layers?) does it load?
- What data does the map contain/present?
- What data types? (do remember data types from GIS?)
]
...
![File tree](imgs/l1/filetree.png)

## Question
How are your course files organized?
]
...
## [Contact me](mailto:cyrille.medarddechardon@uni.lu) if you have any questions.

cyrille.medarddechardon@uni.lu
